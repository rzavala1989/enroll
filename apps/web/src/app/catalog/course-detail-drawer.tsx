                ...
                >
                  <div className="flex items-start justify-between">
                    ...
                    <div className="ml-2 shrink-0 text-right">
                      ...
                      {sec.waitlistCount > 0 && (
                        <div className="mt-0.5 text-[10px] text-wait">
                  ...
                  <button
                    ...
                    className="w-full rounded-sm bg-pine px-3 py-2 text-center text-xs font-medium text-paper transition-colors hover:bg-pine-dark"
                  >
